...
<head>
  ...
  <title><?= esc($title) ?> — <?= esc($ciudad) ?></title>
...
<main class="container">
  ...
  <header class="bg-white rounded-2xl p-6 shadow mb-6 flex flex-col lg:flex-row items-center gap-6">
    <img src="<?= esc($imagenHero) ?>" alt="<?= esc($title) ?>" class="w-full lg:w-1/2 h-64 object-cover rounded-md shadow-sm">
    <div class="lg:w-1/2">
      <h1 class="text-3xl font-bold text-emerald-700 mb-2"><?= esc($title) ?></h1>
