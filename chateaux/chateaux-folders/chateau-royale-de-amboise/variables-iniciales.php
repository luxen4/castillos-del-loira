...
$ciudad = "Amboise"; $slug = "chateau-royale-de-amboise";
$carpeta='chateaux';
...
$keywords = "$nombreLugar, castillos Valle del Loira, turismo Francia, viaje a $ciudad, Leonardo da Vinci, castillos del Loira, historia de Francia";
