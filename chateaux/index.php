...
$title = "Guía de los Castillos del Valle del Loira";
$descripcion = "Descubre los castillos más famosos del Valle del Loira: Chambord, Chenonceau, Amboise, Villandry y muchos más. Historia, consejos y enlaces oficiales para planificar tu visita.";
$keywords = "castillos del Valle del Loira, Château de Chambord, Château de Chenonceau, turismo Valle del Loira, castillos de Francia, rutas culturales Francia";

$graph_Meta_Tags_property_image_width  = "1200";
$graph_Meta_Tags_property_image_height = "630";

$graph_Meta_Tags_property_section = "Castillos y patrimonio histórico del Valle del Loira";

$graph_Meta_Tags_property_tag  = $title;
$graph_Meta_Tags_property_tag2 = "Castillos del Valle del Loira";
$graph_Meta_Tags_property_tag3 = "Turismo Francia";

$twitterCards_url = "https://alayag82.kesug.com/val-de-loire/chateaux/";
...
<html lang="es">
<head>
  <?php include $_SERVER['DOCUMENT_ROOT'] . '/val-de-loire/chateaux/head/index.php'; ?>
  <?php include $_SERVER['DOCUMENT_ROOT'] . '/val-de-loire/chateaux/head/schemas-head.php'; ?>
</head>
...
<header class="bg-emerald-700 text-white py-6 shadow-md">
  <div class="container mx-auto text-center px-4">
    <h1 class="text-3xl font-bold">🏰 Castillos del Valle del Loira</h1>
    <p class="mt-2 text-emerald-200">
      Guía completa de los castillos más emblemáticos de Francia
    </p>
  </div>
</header>
...
<main class="container mx-auto px-4 py-10">
  <div class="grid grid-cols-1 xl:grid-cols-12 gap-6">
    ...
    <!-- ASIDE IZQUIERDO -->
    <aside class="hidden xl:block xl:col-span-2 space-y-6">
    ...
    <section class="xl:col-span-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <?php
        $archivo_csv = "guia-castillos.csv";
        ...
        <?php if (!empty($items)): ?>
          ...
          <?php foreach ($items as $c): ?>
            ...
            <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition">
              ...
              <img src="<?= htmlspecialchars($c['imagen']) ?>"
                ...
                <div class="flex justify-between items-center mt-3">
                  ...
                  <?php if (!empty($c['url_interna'])): ?>
                    <a href="<?= htmlspecialchars($c['url_interna']) ?>"
                       class="text-sm text-emerald-900 font-bold">
                      Más info
                    </a>
                  <?php endif; ?>
                </div>
            ...
            <!-- 📢 PUBLICIDAD CADA 3 CASTILLOS -->
            <?php if ($i % 3 === 0): ?>
              <div class="sm:col-span-2 lg:col-span-3">
                <div class="bg-emerald-50 border border-emerald-100 rounded-xl shadow p-4 text-center">
                  <?php
                  $alineacion = 4;
        ...
        <?php else: ?>
          <p class="text-gray-500 text-sm">
            No hay castillos disponibles en este momento.
          </p>
        <?php endif; ?>
...
<footer class="bg-emerald-700 text-white text-center py-6 mt-10">
  <p>© <?= date('Y'); ?> Valle del Loira · Guía turística y cultural</p>
  <p class="text-sm text-emerald-200">
    Consulta siempre los sitios oficiales para horarios y entradas
  </p>
</footer>
