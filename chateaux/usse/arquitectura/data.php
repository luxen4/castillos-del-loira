...
$texto = '
  <h3 class="text-lg italic text-gray-600 mb-4">
    El castillo que inspiró a La Bella Durmiente.
  </h3>
  <p class="text-gray-700 leading-relaxed">
    El Castillo de Ussé, conocido como el “Castillo de los Cuentos”, destaca por su arquitectura renacentista y medieval que combina torres almenadas, fachadas elegantes y jardines cuidados. 
    Sus interiores conservan muebles históricos, tapices y decoraciones que transportan al visitante a la época de los duques de Blacas y de la corte francesa.
  </p>
';
