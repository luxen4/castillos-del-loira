<?php
// 🌿 SECCIÓN: ARQUITECTURA Y JARDINES DE VILLANDRY
$titulo = "🌿 Arquitectura y jardines de Villandry";
$texto = '
  <h3 class="text-lg italic text-gray-600 mb-4">
    Donde la geometría del arte se une con la armonía de la naturaleza.
  </h3>
  <p class="text-gray-700 leading-relaxed">
    El <strong>Castillo de Villandry</strong> combina una arquitectura renacentista sobria con uno de los conjuntos 
    de <strong>jardines ornamentales más refinados de Europa</strong>. Sus terrazas ajardinadas, diseñadas según los principios 
    geométricos del siglo XVI, incluyen el <em>jardín del amor</em>, el <em>huerto decorativo</em> y el <em>jardín acuático</em>. 
    Cada espacio fue concebido para reflejar la armonía entre el hombre y la naturaleza, en perfecta simetría y equilibrio visual.
  </p>
';
