...
<?php
// Variables principales del bloque "Alojamientos en Amboise"
$section = [
  "id" => "alojamientos-amboise",
  "titulo" => "🏨 Alojamientos en Amboise",
  "descripcion" => "Amboise cuenta con una amplia oferta de alojamientos: hoteles con encanto, apartamentos turísticos y casas rurales para disfrutar del Valle del Loira.",
  "tip" => "👉 Consejo: elige alojamientos cerca del centro histórico o del río Loira para moverte a pie y disfrutar de las mejores vistas."
];
?>
