    ...
    $items = [
      [
        "titulo" => "Machines de l’Île",
        "descripcion" => "Un parque artístico y mecánico único en el mundo, famoso por el Gran Elefante que recorre la isla de Nantes.",
        "imagen" => [
          "src" => "https://www.lesmachines-nantes.fr/wp-content/uploads/2018/01/home_01.jpg",
          "alt" => "Machines de l'île Nantes",
          "fuente" => "/val-de-loire/ciudades/nantes/lugares-interesantes/las-maquinas-de-la-isla.php",
          "fuente_texto" => "lesmachines-nantes.fr"
        ]  /* https://www.lesmachines-nantes.fr */
      ],
      [
        "titulo" => "Jardin des Plantes",
        "descripcion" => "Un hermoso jardín botánico con invernaderos, esculturas y miles de especies de plantas, ideal para un paseo tranquilo.",
        "imagen" => [
          ...
          "fuente" => "/val-de-loire/ciudades/nantes/lugares-interesantes/jardin-des-plantes.php",
          "fuente_texto" => "levoyageanantes.fr"
        ]/* https://www.levoyageanantes.fr */
        ],
      [
        "titulo" => "Ribera del Loira",
        "descripcion" => "Pasea junto al río Loira, descubre murales artísticos y disfruta de terrazas con vistas inigualables.",
        "imagen" => [
          "src" => "https://crtb.cloudly.space/app/uploads/crt-bretagne/2018/11/thumbs/nantes-parc-des-chantiers-le-de-nantesfranck-tomps-4-1920x960.jpg",
          "alt" => "Jardin des Plantes Nantes",
          "fuente" => "https://www.vacaciones-bretana.com/destinos/10-destinos/nantes/",
          "fuente_texto" => "vacaciones-bretana.com"
        ]
      ]
    ];
    ?>
