...
<?php
// Variables principales del bloque "Acontecimientos en Orléans"
$section = [
  "id" => "acontecimientos",
  "titulo" => "📅 Acontecimientos en Orléans",
  "descripcion" => "Orléans es una ciudad culturalmente activa, con eventos durante todo el año, desde festivales de música y teatro hasta mercados tradicionales y espectáculos callejeros.",
  "tip" => "👉 Consejo: revisa el calendario oficial de Orléans para planificar tu visita y no perderte los eventos más importantes de la ciudad."
];
?>
