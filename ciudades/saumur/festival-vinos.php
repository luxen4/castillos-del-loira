...
$sitio_web = "https://alayag82.kesug/valle-del-loira";
$imagenHero = $sitio_web . "/assets/festival-vinos-saumur-hero.jpg";
$keywords = "Festival de Vinos, Saumur, Catas de Vino, Bodegas Valle del Loira, Gastronomía, Música en Vivo, Eventos en Saumur";
$carpeta = "ciudades/nantes/lugares-interesantes";
...
<body class="bg-gray-50 text-gray-900 antialiased">
  ...
  <main class="px-4 sm:px-6 lg:px-8 py-10
             md:mx-[15em] lg:mx-[15em] max-w-[calc(100%-2rem)]">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <!-- Main -->
<section class="lg:col-span-6 space-y-6 max-h-[80vh] overflow-y-auto">
