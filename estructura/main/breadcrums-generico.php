...
<ol class="flex flex-wrap items-center gap-2">
    ...
    <li><a href="/val-de-loire/index.php#<?= $bread_crums_second; ?>" class="font-semibold text-blue-700 hover:text-blue-900 transition-colors"><?= $carpeta; ?></a></li>
