  ...
  <header class="bg-emerald-700 text-white shadow-md py-6">
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-6">
      ...
      <nav class="mt-4 md:mt-0 flex gap-4">
        <a href="index.html" class="px-4 py-2 rounded-lg bg-white text-emerald-700 font-semibold hover:bg-gray-100 transition">🏠 Página Principal</a>
      ...
      <article class="space-y-6">
        ...
        <div class="grid md:grid-cols-2 gap-6">
          <figure class="rounded-lg overflow-hidden shadow-lg">
            <img src="img/castillos/castle-Serrant.png" alt="Château de Serrant" class="w-full h-auto object-cover">
            <figcaption class="text-center text-gray-600 p-2">Château de Serrant</figcaption>
          </figure>
          <figure class="rounded-lg overflow-hidden shadow-lg">
            <img src="img/castillos/castle-ancenis.png" alt="Château de Ancenis" class="w-full h-auto object-cover">
            <figcaption class="text-center text-gray-600 p-2">Château de Ancenis</figcaption>
          </figure>
        </div>
        ...
        <details class="bg-white rounded-lg shadow-md p-4">
          ...
          <div class="grid md:grid-cols-3 gap-4 mt-4">
            <a href="https://www.loira-atlantico.com/visitas/castillos/chateau-d-ancenis" target="_blank" class="block hover:scale-105 transition transform">
              <img src="img/castillos/castle-Ancenis.png" alt="Château de Ancenis" class="rounded-lg shadow-md">
              <p class="text-center text-gray-700 mt-2">Château de Ancenis</p>
            </a>
            <a href="http://www.plessis-bourre.com/en/" target="_blank" class="block hover:scale-105 transition transform">
              <img src="img/castillos/castle-Plessis-Bourré.jpg" alt="Château de Plessis-Bourré" class="rounded-lg shadow-md">
              <p class="text-center text-gray-700 mt-2">Château de Plessis Bourré</p>
            </a>
            <a href="https://chateau-plessis-mace.fr/fr/" target="_blank" class="block hover:scale-105 transition transform">
              <img src="img/castillos/castle-Plessis-Macé.jpg" alt="Château de Plessis-Macé" class="rounded-lg shadow-md">
              <p class="text-center text-gray-700 mt-2">Château de Plessis-Macé</p>
            </a>
          </div>
        </details>
      </article>
