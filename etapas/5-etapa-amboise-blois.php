...
<meta name="twitter:title" content="Estoy en Amboise y Blois">
<meta content="@frikiShirt" name="twitter:site">
<meta content="@frikiShirt" name="twitter:creator">
<meta name="twitter:image" content="img/logo.png">
<meta name="twitter:description" content="Zona entre Amboise y Blois, una parada obligada en tu ruta por el valle del Loira">

  <title>Etapa Amboise | Blois</title>
...
<body>
 ...
 <?php
      $zona_atras_enlace = "etapa-tours-amboise.php";
      $zona_atras_marcador = "Zona Tours y Amboise";
      $zona_adelante_enlace = "etapa-blois-orleans.php";
      $zona_adelante_marcador = "Zona Blois y Orleans";
  ...
  <div class="container">
    ...
    <div class="row">
      <section class="col-xl-12 text-center col-lg-12 col-md-12 col-sm-12 col-12">
          ...
          <h4 class="titulo-ciudad">Zona de Amboise y Blois.</h4>
          <p>bla, bla, bla</p>
