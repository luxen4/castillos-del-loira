...
<head>
  ...
  <title>Ruta Valle del Loira: Orléans – Blois</title>
  <meta name="description" content="Descubre la ruta del Valle del Loira entre Orléans y Blois: castillos, ríos y paisajes históricos.">
  <meta name="keywords" content="Valle del Loira, Orléans, Blois, castillos, turismo Francia, viaje">
  <meta name="author" content="TuNombre">

  <!-- Open Graph -->
  <meta property="og:title" content="Ruta Valle del Loira: Orléans – Blois">
  <meta property="og:description" content="Explora castillos y paisajes entre Orléans y Blois. Información práctica y fotos.">
...
<body class="bg-gray-50 text-gray-800 font-sans">
  ...
  <header class="bg-emerald-700 text-white shadow-md py-6">
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-6">
      <h1 class="text-3xl md:text-4xl font-extrabold">🌿 Valle del Loira: Orléans – Blois</h1>
  ...
  <section class="container mx-auto px-6 py-10 text-center bg-emerald-50 rounded-lg shadow-lg mt-6">
    <h2 class="text-3xl md:text-5xl font-extrabold text-emerald-700 mb-4">Ruta entre Orléans y Blois</h2>
    <p class="text-lg md:text-xl text-gray-700 mb-6">
      Recorre el Valle del Loira desde Orléans hasta Blois, descubriendo castillos históricos, paisajes fluviales y la riqueza cultural de la región.
    </p>
  ...
  <section id="nav1" class="container mx-auto px-6 py-8 bg-white rounded-lg shadow mt-6">
    ...
    <ul class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <li class="text-center">
        <a href="https://www.chateau-chaumont.fr/en" target="_blank">
  ...
  <section id="mapa" class="container mx-auto px-6 py-10">
    <h3 class="text-2xl font-bold text-emerald-700 mb-4 text-center">🗺️ Mapa de la ruta Orléans – Blois</h3>
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d978168.123456789!2d1.903!3d47.900!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2ses!4v1759333377000!5m2!1ses!2ses"
