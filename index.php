...
<!-- verify-admitad: "e3b1ce5433" -->
  ...
  <div class="container mx-auto px-1 py-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
    ...
    <aside class="lg:col-span-2 bg-emerald-50 p-2 rounded-xl shadow space-y-1">
      ...
      <div>
        <h4 class="font-semibold text-gray-700 mb-1">
          <a href="#localidades-principales" class="hover:text-emerald-700 underline">
    ...
    <main class="lg:col-span-7 space-y-10">
      ...
      <?php require $_SERVER["DOCUMENT_ROOT"] . '/val-de-loire/paginas/index/main/sections/data-datos-rapidos.php'; ?>

      <?php require "estructura/index/main/sections/mejor-epoca.php"; ?>
      <?php //require "estructura/index/main/sections/ideal-para.php"; ?>

      <?php //require "estructura/index/main/sections/duracion-y-consejos.php"; ?>
      <?php require "estructura/index/main/sections/vinos-emblematicos.php"; ?>
      ...
      <?php require "estructura/index/main/sections/localidades-principales.php"; ?>
