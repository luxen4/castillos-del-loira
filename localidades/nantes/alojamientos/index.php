...
<div class="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-12 gap-6">
  ...
  <aside class="lg:col-span-3 space-y-6">
    ...
    <div class="bg-white rounded-xl shadow p-4 text-center">
      <p class="text-sm text-gray-500 mb-2">Publicidad</p>
    ...
    <div class="bg-white rounded-xl shadow p-4">
      ...
      <ul class="space-y-2 text-sm">
        <li>
          <a href="https://www.levoyageanantes.fr" target="_blank" rel="noopener noreferrer"
  ...
  <main class="lg:col-span-6 space-y-8">
    ...
    <section class="bg-white rounded-xl shadow p-6">
      <h2 class="text-xl font-semibold mb-4">Dónde alojarse en Nantes</h2>
    ...
    <section class="grid md:grid-cols-2 gap-6">
      ...
      <article class="bg-white rounded-xl shadow p-5">
        ...
        <a href="#" class="inline-flex items-center gap-2 text-emerald-700 font-medium hover:underline">
  ...
  <aside class="lg:col-span-3 space-y-6">
    ...
    <div class="bg-white rounded-xl shadow p-4">
      ...
      <ul class="space-y-2 text-sm">
        <li>
          <a href="/val-de-loire/localidades/nantes/index.php" class="text-emerald-700 hover:underline">
            Nantes – Guía turística
          </a>
        </li>
        <li>
          <a href="/val-de-loire/general/gastronomia/index.php" class="text-emerald-700 hover:underline">
            Gastronomía local
          </a>
        </li>
      </ul>
