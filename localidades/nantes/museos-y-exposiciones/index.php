...
<head>
    ...
    <!-- CANONICAL -->
    <link rel="canonical" href="<?= $web_site; ?>/localidades/nantes/museos-nantes/index.php">
...
<main class="col-span-12 lg:col-span-6 px-4 lg:px-0">
    ...
    <section id="contenedorTarjetas" class="space-y-6">
        ...
        <div class="p-5 bg-white shadow rounded-xl border tarjeta" data-tipo="museos">
            <a href="/val-de-loire/localidades/nantes/museos-y-exposiciones/musse-arts-de-nantes/index.php"
        ...
        <div class="p-5 bg-white shadow rounded-xl border tarjeta" data-tipo="museos">
            <a href="/val-de-loire/localidades/nantes/museos-y-exposiciones/musse-histoire-nantes/index.php"
                class="text-emerald-700 font-semibold hover:underline hover:text-emerald-900 transition">
        ...
        <div class="p-5 bg-white shadow rounded-xl border tarjeta" data-tipo="museos">
            <a href="/val-de-loire/localidades/nantes/lugares-interesantes/les-machines-ille/index.php"
                class="text-emerald-700 font-semibold hover:underline hover:text-emerald-900 transition">
        ...
        <div class="p-5 bg-white shadow rounded-xl border tarjeta" data-tipo="museos">
            <a href="/val-de-loire/localidades/nantes/museos-y-exposiciones/museo-julio-verne/index.php"
                class="text-emerald-700 font-semibold hover:underline hover:text-emerald-900 transition">
        ...
        <div class="p-5 bg-white shadow rounded-xl border tarjeta" data-tipo="museos">
            <a href="/val-de-loire/localidades/nantes/museos-y-exposiciones/jardin-des-plantes-nantes/index.php"
                class="text-emerald-700 font-semibold hover:underline hover:text-emerald-900 transition">
        ...
        <div class="p-5 bg-white shadow rounded-xl border tarjeta" data-tipo="exposiciones">
            <a href="/val-de-loire/localidades/nantes/museos-y-exposiciones/lumieres-sur-la-loire-nantes/index.php"
                class="text-emerald-700 font-semibold hover:underline hover:text-emerald-900 transition">
