...
<section id="alojamientos" class="my-10 px-6 lg:px-0">
  ...
  <p class="text-gray-700 leading-relaxed">
    ...
    alrededor de Orléans permiten disfrutar del entorno tranquilo y verde del <a class="text-emerald-600 font-semibold underline hover:text-emerald-800 transition" href="/val-de-loire/index.phpZ><strong>Valle del Loira</strong></a> en un ambiente relajado.
  </p>
