...
<head>
  ...
  <script type="application/ld+json">
  {
    ...
    "url": "https://tusitioweb.example/val-de-loire/",
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://tusitioweb.example/search?q={search_term_string}",
  ...
  <script type="application/ld+json">
  {
    ...
    "@type":"BreadcrumbList",
    "itemListElement":[
      {"@type":"ListItem","position":1,"name":"Inicio","item":"https://tusitioweb.example/"},
      {"@type":"ListItem","position":2,"name":"Valle del Loira","item":"https://tusitioweb.example/val-de-loire/"},
      {"@type":"ListItem","position":3,"name":"Loire à Vélo","item":"https://tusitioweb.example/val-de-loire/loire-a-velo"}
    ]
  }
  </script>
