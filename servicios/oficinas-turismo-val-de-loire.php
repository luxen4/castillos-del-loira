...
<body class="bg-gray-50 text-gray-800 font-sans leading-relaxed">
  ...
  <header class="bg-emerald-700 text-white py-6 shadow-md">
    <div class="container mx-auto text-center">
      <h1 class="text-3xl font-bold">🌿 Oficinas de Turismo del Valle del Loira</h1>
      <p class="text-emerald-100 mt-2">Información oficial para descubrir las joyas del Loira</p>
    </div>
  </header>

<main class="container mx-auto px-6 py-12">
  <div class="grid lg:grid-cols-[250px_1fr_250px] gap-8">

    <!-- Aside izquierdo -->
    <aside class="hidden lg:block bg-gray-200 text-gray-500 p-4 rounded-lg">
    ...
    <!-- Contenido principal -->
    <section id="oficinas-turismo" class="bg-white rounded-2xl shadow p-8">
      ...
      <!-- Grid con oficinas por zonas -->
      <div class="grid md:grid-cols-2 gap-8">
        <!-- Zona Oeste -->
        <div>
          <h3 class="text-xl font-semibold text-emerald-700 mb-4">🗺️ Zona Oeste</h3>
          <ul class="space-y-3 text-gray-700">
            <li><a href="/val-de-loire/ciudades/Nantes.php#turismo-nantes" class="text-emerald-700 font-medium hover:underline">Nantes</a> — Oficina Metropolitana</li>
      ...
      $archivoPublicidad = "sneakers"; $alineacion=4;
